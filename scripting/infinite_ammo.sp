...
public Plugin:myinfo = {
	name 						= "Infinite Ammo",
	author 						= "BCServ - Chanz & Modified by JonnyBoy0719",
	description 				= "Like the title says INFINITE AMMO for all weapons in Contagion",
	version 					= "1.2",
	url 						= ""
}
...
public OnPluginStart()
{
	...
	PluginManager_Initialize("infinite-ammo", "[SM] ");
...
public Action:CommandHook_All(client, const String:command[], argc){
	...
	PrintToConsole(client,"Command: '%s %s'",command,argString);
